...
export default function PostsList() {
  ...
  useEffect(() => {
    if (postList) setDeletedProducts(postList);
  }, [postList]);
    ...
    <>
      <section>
          ...
          <div className='container mx-auto px-4'>
            <div className='mb-16 flex flex-wrap items-center'>
              <div className='w-full lg:w-1/2'>
                <span className='text-gray-600 font-bold'>Trendy Fashion</span>
              ...
              <div className='w-full lg:w-3/4 px-3'>
                ...
                {loading ? (
                  ...
                  deletedProducts?.map((post) => (
                    <div
                      key={post?._id}
                      className='flex items-center flex-wrap bg-gray-200 -mx-3  lg:mb-6'
                    >
                      <div className='flex items-center w-full px-3 justify-end'>
                        <button
                          className='text-white bg-red-600 rounded-lg py-2 px-4 mb-2 md: -mb-10 font-bold'
        ...
        <div className='bg-gray-900'>
          <div className='skew bg-green-500 skew-bottom mr-for-radius'></div>
          <div className='skew bg-gray-500  skew-bottom ml-for-radius'></div>
        </div>
      </section>
    </>
  );
